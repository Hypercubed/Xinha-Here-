...
function XinhaHere(editor) {
  ...
  var id = "xinhahere";
	...
	cfg.registerButton("xhabout", this._lc("About this editor"), editor.imgURL("ed_about.gif", "XinhaHere"), false,
		function(editor, id) { editor._popupDialog("../../about.xul", null, editor); });
	cfg.addToolbarElement(["xhabout"], ["about"], 0);  // To be used as replacement for Xinha about box
