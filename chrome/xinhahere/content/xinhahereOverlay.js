...
var xinhahereOverlay = {
  ...
  show_ops: function() {
		var e_par = "chrome,titlebar,toolbar,centerscreen,modal";
		var e_url = "chrome://xinhahere/content/options.xul";
		window.openDialog(e_url, "xinha_options", e_par);
	},
	
  show_about: function() {
		var e_url = "chrome://xinhahere/content/about.xul";
		//var e_url = "chrome://xinhahere/content/xinha-core/plugins/xinhahere/about.html";
		var e_par = "toolbar=no,menubar=no,personalbar=no,width=300,height=420,"
				+"left=20,top=40,scrollbars=yes,resizable=yes,dependent=yes,chrome=yes";
		window.open(e_url, "xinha_about", e_par);
	},
